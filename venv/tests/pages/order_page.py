...
class OrderPage:
    ...
    def set_address(self):
        self.driver.find_elements(*OrderPageLocators.inputs)[2].send_keys('Москва, Зорге, 36')

    @allure.step('Ввести данные в поле ввода с плейсхолдером Станция метро')
    def set_metro_station(self):
        self.driver.find_element(*OrderPageLocators.metro_station_input).send_keys('Выхино')
    ...
    def set_phone_number(self):
        self.driver.find_elements(*OrderPageLocators.inputs)[3].send_keys('+79850600206')
    ...
    def set_date(self):
        self.driver.find_elements(*OrderPageLocators.second_page)[0].send_keys('18.03.2023')
    ...
    def order_has_been_placed_text(self):
        return WebDriverWait(self.driver, 5).until(ec.visibility_of_element_located(OrderPageLocators.text)).text