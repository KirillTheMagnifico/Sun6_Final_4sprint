...
class MainPage:
    ...
    def click_question_two(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_two_element))
        element.click()
    ...
    def click_question_three(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_three_element))
        element.click()
    ...
    def click_question_four(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_four_element))
        element.click()
    ...
    def click_question_five(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_five_element))
        element.click()
    ...
    def click_question_six(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_six_element))
        element.click()
    ...
    def click_question_seven(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_seven_element))
        element.click()
    ...
    def click_question_eight(self):
        last_element = self.driver.find_element(*MainPageLocators.locator_question_eight_element)
        self.driver.execute_script('arguments[0].scrollIntoView();', last_element)
        element = WebDriverWait(self.driver, 30).until(ec.visibility_of_element_located(MainPageLocators.locator_question_eight_element))
        element.click()
